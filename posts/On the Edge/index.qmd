...
In addition, those on the river can decouple issues and analyze them. This is foreign to politicians who punish members of their team when they go against the group consensus. Politicians also seem more focused on passing bills that build a brand and show their virtue - they focus on intentions rather than results. For example, an analytical mind on the River would not invest \$42 billion in a project that produces zero results in more than 1000 days - even if their team voted for it. Instead, they would consider the EV of these bills and revise their program requirements and planned implementations to produce a positive EV. As discussed later, they would also "fold" if new information becomes available and the EV becomes clearly negative.

{{< tweet BrendanCarrFCC 1829206944160375259 >}}

Those on the river are also comfortable with randomization. I happen to being reading another book that also talks about about game theory optimal decisions: sometimes a mixed strategy based on a random input is the best one. A rule follower - someone that prefers deterministic models to stochastic ones - would not be comfortable with this.
...
-   Successful risk takers focus on process and not on results. This is counterintuitive to many people in business. The example he used is a poker player, among the top 100 in skill, may possess a 40 percent chance of loosing money in a year even though their median income is \$33,000 (pg. 110).
-   Successful risk takers raise or fold and possess a selective attention to detail. This is also counterintuitive: The growing commitment to a bet with an increasingly positive EV as well as the refusal to bend analysis to accommodate sunk costs. The focus on what is most important is also counterintuitive for those habituated to seek more and more data.
...
This was a great book. Even though it is not science-fiction, Silver mentioned that science fiction is the favorite fiction genre of the River (pg. 453). It motivated me to learn the math of poker and consider betting on sports games. 
